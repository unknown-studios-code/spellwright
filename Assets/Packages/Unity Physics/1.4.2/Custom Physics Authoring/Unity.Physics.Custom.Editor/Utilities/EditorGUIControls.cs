...
namespace Unity.Physics.Editor
{
    ...
    internal static class EditorGUIControls
    {
        ...
        {
            EditorGUI.HelpBox(EditorGUI.PrefixLabel(position, label), string.Format(Styles.CompatibilityWarning, incompatibleType), MessageType.Error);
        }
        ...
        public static void SoftSlider(Rect position, GUIContent label, SerializedProperty property, float sliderMin, float sliderMax, float textFieldMin, float textFieldMax)
        {
