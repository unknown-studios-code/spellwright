...
namespace Unity.Physics.Editor
{
    ...
    public class EditorUtilities
    {
        ...
        public static void EditPivot(RigidTransform worldFromA, RigidTransform worldFromB, bool lockBtoA, ref float3 pivotA, ref float3 pivotB, Object target)
        {
        ...
        public class AxisEditor
        {
            ...
            public void Update(
                ...
                float3 pivotA,
                float3 pivotB,
                ref float3 directionA,
                ref float3 directionB,
                ref float3 perpendicularA,
                ref float3 perpendicularB,
                Object target
            )
            {
                // Work in world space
                ...
                if (target != m_LastTarget)
                {
                    ...
                    var rotationA = new float3x3(directionAinW, perpendicularAinW, math.cross(directionAinW, perpendicularAinW));
                    ...
                    else
                    {
                        ...
                        var rotationB = new float3x3(directionBinW, perpendicularBinW, math.cross(directionBinW, perpendicularBinW));
        ...
        public static void EditLimits(
            ...
            float3 axisA,
            float3 axisB,
            float3 perpendicularA,
            float3 perpendicularB,
            ref float minLimit,
            ref float maxLimit,
            JointAngularLimitHandle limitHandle,
            Object target
        )
        {
