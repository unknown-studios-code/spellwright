...
namespace Unity.Physics.Editor
{
    ...
    {
        private static PhysicsBoundsHandleUtility.Corner[] s_Corners = new PhysicsBoundsHandleUtility.Corner[8];
        ...
        protected override void DrawWireframe()
        {
            ...
            bool isCameraInsideBox = Camera.current != null && bounds.Contains(invMatrix.MultiplyPoint(cameraPos));
            ...
            PhysicsBoundsHandleUtility.CalculateCornerHorizon(
                origin + (corner * new float3(-1f, 1f, -1f)),
                quaternion.LookRotation(-axisz, axisy),
                cameraCenter,
                cameraForward,
                cameraOrtho,
                radius,
            ...
            PhysicsBoundsHandleUtility.CalculateCornerHorizon(
                origin + (corner * new float3(-1f, 1f, 1f)),
                quaternion.LookRotation(-axisx, axisy),
                cameraCenter,
                cameraForward,
                cameraOrtho,
                radius,
