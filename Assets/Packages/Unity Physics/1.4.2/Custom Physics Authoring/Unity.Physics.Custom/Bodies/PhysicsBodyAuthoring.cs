...
namespace Unity.Physics.Authoring
{
    ...
    {
        private const string k_IconPath = "Packages/com.unity.physics/Unity.Physics.Editor/Editor Default Resources/Icons/d_Rigidbody@64.png";
...
#pragma warning restore 618
        ...
        {
            get =>
                new() { Transform = new RigidTransform(m_Orientation, m_CenterOfMass), InertiaTensor = m_MotionType == BodyMotionType.Dynamic ? m_InertiaTensor : new float3(float.PositiveInfinity) };
            set
            {
...
#pragma warning restore 618
        ...
        [SerializeField]
        private float3 m_CenterOfMass;

        [SerializeField]
        private EulerAngles m_Orientation = EulerAngles.Default;

        [SerializeField]
        private
        // Default value to solid unit sphere : https://en.wikipedia.org/wiki/List_of_moments_of_inertia
        float3 m_InertiaTensor = new(2f / 5f);
