...
namespace Unity.Physics.Authoring
{
    ...
    public struct CustomPhysicsMaterialTags : IEquatable<CustomPhysicsMaterialTags>
    {
        ...
        public readonly bool Equals(CustomPhysicsMaterialTags other) => Value == other.Value;

        public override readonly bool Equals(object obj) => obj is CustomPhysicsMaterialTags other && Equals(other);
