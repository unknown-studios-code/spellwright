...
namespace Unity.Physics.Authoring
{
    ...
    internal struct ModifyJointLimits : ISharedComponentData, IEquatable<ModifyJointLimits>
    {
        ...
        public readonly bool Equals(ModifyJointLimits other) => AngularRangeScalar.Equals(other.AngularRangeScalar) && LinearRangeScalar.Equals(other.LinearRangeScalar);

        public override readonly bool Equals(object obj) => obj is ModifyJointLimits other && Equals(other);

        public override readonly int GetHashCode() => unchecked((AngularRangeScalar.GetHashCode() * 397) ^ LinearRangeScalar.GetHashCode());
    }
    ...
    public class ModifyJointLimitsAuthoring : MonoBehaviour
    {
        public ParticleSystem.MinMaxCurve AngularRangeScalar = new(
            1f,
            min: new AnimationCurve(new Keyframe(0f, 0f, 0f, 0f), new Keyframe(2f, -2f, 0f, 0f), new Keyframe(4f, 0f, 0f, 0f)) { preWrapMode = WrapMode.Loop, postWrapMode = WrapMode.Loop },
            max: new AnimationCurve(new Keyframe(0f, 1f, 0f, 0f), new Keyframe(2f, -1f, 0f, 0f), new Keyframe(4f, 1f, 0f, 0f)) { preWrapMode = WrapMode.Loop, postWrapMode = WrapMode.Loop }
        );

        public ParticleSystem.MinMaxCurve LinearRangeScalar = new(
            1f,
            min: new AnimationCurve(new Keyframe(0f, 1f, 0f, 0f), new Keyframe(2f, 0.5f, 0f, 0f), new Keyframe(4f, 1f, 0f, 0f)) { preWrapMode = WrapMode.Loop, postWrapMode = WrapMode.Loop },
            max: new AnimationCurve(new Keyframe(0f, 0.5f, 0f, 0f), new Keyframe(2f, 0f, 0f, 0f), new Keyframe(4f, 0.5f, 0f, 0f)) { preWrapMode = WrapMode.Loop, postWrapMode = WrapMode.Loop }
        );
    }
    ...
    internal class ModifyJointLimitsBaker : Baker<ModifyJointLimitsAuthoring>
    {
        public override void Bake(ModifyJointLimitsAuthoring authoring)
        {
            ...
            AddComponentObject(entity, new ModifyJointLimitsBakingData { AngularRangeScalar = authoring.AngularRangeScalar, LinearRangeScalar = authoring.LinearRangeScalar });
        }
    }
    ...
    internal partial struct ModifyJointLimitsBakingSystem : ISystem
    {
        ...
        public void OnCreate(ref SystemState state)
        {
            _ModifyJointLimitsBakingDataQuery = state.GetEntityQuery(
                new EntityQueryDesc { All = new[] { ComponentType.ReadOnly<ModifyJointLimitsBakingData>() }, Options = EntityQueryOptions.IncludeDisabledEntities | EntityQueryOptions.IncludePrefab }
            );

            _JointEntityBakingQuery = state.GetEntityQuery(new EntityQueryDesc { All = new[] { ComponentType.ReadOnly<JointEntityBaking>() } });
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            foreach (
                (RefRO<JointEntityBaking> jointEntity, RefRO<PhysicsJoint> physicsJoint, Entity entity) in SystemAPI
                    .Query<RefRO<JointEntityBaking>, RefRO<PhysicsJoint>>()
                    .WithEntityAccess()
            ...
            foreach (
                (ModifyJointLimitsBakingData modifyJointLimits, Entity entity) in SystemAPI
    ...
    internal partial struct ModifyJointLimitsSystem : ISystem
    {
        public readonly void OnUpdate(ref SystemState state)
        {
            ...
            foreach ((RefRW<PhysicsJoint> joint, ModifyJointLimits modification) in SystemAPI.Query<RefRW<PhysicsJoint>, ModifyJointLimits>())
            {
                var animatedAngularScalar = new FloatRange(modification.AngularRangeScalar.curveMin.Evaluate(time), modification.AngularRangeScalar.curveMax.Evaluate(time));
                var animatedLinearScalar = new FloatRange(modification.LinearRangeScalar.curveMin.Evaluate(time), modification.LinearRangeScalar.curveMax.Evaluate(time));
                ...
                switch (joint.ValueRW.JointType)
                {
                    ...
                    case JointType.RagdollPrimaryCone:
                        modification.InitialValue.GetRagdollPrimaryConeAndTwistRange(out float maxConeAngle, out FloatRange angularTwistRange);
                        joint.ValueRW.SetRagdollPrimaryConeAndTwistRange(maxConeAngle * animatedAngularScalar.Max, angularTwistRange * (float2)animatedAngularScalar);
                        break;
