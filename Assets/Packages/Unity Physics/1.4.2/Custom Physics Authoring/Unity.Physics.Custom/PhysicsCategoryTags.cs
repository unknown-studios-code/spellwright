...
namespace Unity.Physics.Authoring
{
    ...
    public struct PhysicsCategoryTags : IEquatable<PhysicsCategoryTags>
    {
        ...
        public readonly bool Equals(PhysicsCategoryTags other) => Value == other.Value;

        public override readonly bool Equals(object obj) => obj is PhysicsCategoryTags other && Equals(other);
