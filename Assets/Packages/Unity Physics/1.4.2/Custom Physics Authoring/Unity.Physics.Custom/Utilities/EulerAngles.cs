...
namespace Unity.Physics.Authoring
{
    ...
    internal struct EulerAngles : IEquatable<EulerAngles>
    {
        ...
        public static implicit operator quaternion(EulerAngles euler) => math.normalize(quaternion.Euler(math.radians(euler.Value), euler.RotationOrder));
        ...
        public override readonly int GetHashCode() => unchecked((int)math.hash(new float4(Value, (float)RotationOrder)));
    }
}
