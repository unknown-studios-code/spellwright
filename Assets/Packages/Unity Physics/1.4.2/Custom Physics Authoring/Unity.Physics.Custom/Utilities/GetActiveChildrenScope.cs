...
{
    public struct GetActiveChildrenScope<T> : IDisposable
        where T : UnityComponent
    {
        ...
        private static List<T> s_Buffer = new(8);

        public readonly List<T> Buffer => m_Disposed ? null : s_Buffer;

        private bool m_Disposed;
        private PhysicsShapeAuthoring m_Shape;
        private Transform m_Root;
        private GameObject m_PrimaryBody;
        private bool m_CheckIfComponentBelongsToShape;
        ...
        public readonly bool IsChildActiveAndBelongsToShape(T child, bool filterOutInvalid = true)
        {
