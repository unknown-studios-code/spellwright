...
namespace Spellwright.Systems.Collision
{
    ...
    public partial struct ConeCollisionSystem : ISystem
    {
        ...
        {
            _query = new EntityQueryBuilder(Allocator.Temp).WithAll<ConeRequest>().Build(ref state);
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            var job = new DetectConeCollisionJob
            {
